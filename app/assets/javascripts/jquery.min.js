...
function b_(a,b,c,d){
    if(f.isArray(b))f.each(b,function(b,e){
        ...
        function bjQuery(a,c,d,e,f,g){
    f=f||c.dataTypes[0],g=g||{},g[f]=!0;
    var h=a[f],i=0,j=h?h.length:0,k=a===bU,l;
    for(;i<j&&(k||!l);i++)l=h[i](c,d,e),typeof l=="string"&&(!k||g[l]?l=b:(c.dataTypes.unshift(l),l=bjQuery(a,c,d,e,l,g)));
    (k||!l)&&!g["*"]&&(l=bjQuery(a,c,d,e,"*",g));
    return l
    }
    function bZ(a){
    return function(b,c){
...
function bD(a,b,c){
    ...
    b.src?f.ajax({
        ...
        async:!1,
        dataType:"script"
    }):f.globalEval((b.text||b.textContent||b.innerHTML||"").replace(bf,"/*jQuery0*/")),b.parentNode&&b.parentNode.removeChild(b)
    }
    function bm(a){
...
function bh(a,b){
    ...
    if(!(a.liveFired===this||!r||!r.live||a.target.disabled||a.button&&a.type==="click")){
        a.namespace&&(n=new RegExp("(^|\\.)"+a.namespace.split(".").join("\\.(?:.*\\.)?")+"(\\.|jQuery)")),a.liveFired=this;
...
function L(a,c,d){
    ...
    function k(a,c,d){
    if(d===b&&a.nodeType===1){
        var e="data-"+c.replace(j,"jQuery1-jQuery2").toLowerCase();
        d=a.getAttribute(e);
        if(typeof d=="string"){
            try{
...
e.fn=e.prototype={
    ...
    noConflict:function(b){
        a.jQuery===e&&(a.jQuery=g),b&&a.jQuery===e&&(a.jQuery=f);
        return e
        },
    isReady:!1,
    readyWait:1,
...
browser:{}
    ...
    }),x=e.uaMatch(w),x.browser&&(e.browser[x.browser]=!0,e.browser.version=x.version),e.browser.webkit&&(e.browser.safari=!0),j.test(" ")&&(k=/^[\s\xA0]+/,l=/[\s\xA0]+jQuery/),h=e(c),c.addEventListener?z=function(){
...
return g.promise()
    ...
    f=c.createElement("select"),g=f.appendChild(c.createElement("option")),h=a.getElementsByTagName("input")[0],j={
        ...
        opacity:/^0.55jQuery/.test(e.style.opacity),
...
var n=/[\n\t\r]/g,o=/\s+/,p=/\r/g,q=/^(?:button|input)jQuery/i,r=/^(?:button|input|object|select|textarea)jQuery/i,s=/^a(?:rea)?jQuery/i,t=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)jQuery/i,u=/\:/,v,w;
f.fn.extend({
    attr:function(a,b){
...
var x=Object.prototype.hasOwnProperty,y=/\.(.*)jQuery/,z=/^(?:textarea|input|select)jQuery/i,A=/\./g,B=/ /g,C=/[^\w\s.|`]/g,D=function(a){
    return a.replace(C,"\\jQuery&")
    };
...
remove:function(a,c,d,e){
    if(a.nodeType!==3&&a.nodeType!==8){
        ...
        c=c.split(" ");
        while(h=c[k++]){
            r=h,q=null,l=h.indexOf(".")<0,m=[],l||(m=h.split("."),h=m.shift(),n=new RegExp("(^|\\.)"+f.map(m.slice(0).sort(),D).join("\\.(?:.*\\.)?")+"(\\.|jQuery)")),p=t[h];
            if(!p)continue;
            if(!d){
...
trigger:function(c,d,e,g){
    ...
    if(!!e&&!f.event.customEvent[h]||!!f.event.global[h]){
        c=typeof c=="object"?c[f.expando]?c:new f.Event(h,c):new f.Event(h),c.type=h,c.exclusive=j,c.namespace=i.join("."),c.namespace_re=new RegExp("(^|\\.)"+i.join("\\.(?:.*\\.)?")+"(\\.|jQuery)");
...
ATTR:function(a,b){
    ...
    return d==null?f==="!=":f==="="?e===g:f==="*="?e.indexOf(g)>=0:f==="~="?(" "+e+" ").indexOf(g)>=0:g?f==="!="?e!==g:f==="^="?e.indexOf(g)===0:f==="jQuery="?e.substr(e.length-g.length)===g:f==="|="?e===g||e.substr(0,g.length+1)===g+"-":!1:e&&d!==!1
    },
...
c.documentElement.compareDocumentPosition?r=function(a,b){
    ...
    if(!b.querySelectorAll||b.querySelectorAll(".TEST").length!==0){
        k=function(b,e,f,g){
            e=e||c;
            if(!g&&!k.isXML(e)){
                var h=/^(\w+jQuery)|^\.([\w\-]+jQuery)|^#([\w\-]+jQuery)/.exec(b);
                ...
                n?o=o.replace(/'/g,"\\jQuery&"):e.setAttribute("id",o),r&&q&&(e=e.parentNode);
                try{
...
var P=/UntiljQuery/,Q=/^(?:parents|prevUntil|prevAll)/,R=/,/,S=/^.[^:#\[\.,]*jQuery/,T=Array.prototype.slice,U=f.expr.match.POS,V={
    children:!0,
    contents:!0,
    next:!0,
    prev:!0
...
var Y=/ jQuery\d+="(?:\d+|null)"/g,Z=/^\s+/,jQuery=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,_=/<([\w:]+)/,ba=/<tbody/i,bb=/<|&#?\w+;/,bc=/<(?:script|object|embed|option|style)/i,bd=/checked\s*(?:[^=]|=\s*.checked.)/i,be=/\/(java|ecma)script/i,bf=/^\s*<!(?:\[CDATA\[|\-\-)/,bg={
...
html:function(a){
    ...
    if(typeof a=="string"&&!bc.test(a)&&(f.support.leadingWhitespace||!Z.test(a))&&!bg[(_.exec(a)||["",""])[1].toLowerCase()]){
        a=a.replace(jQuery,"<jQuery1></jQuery2>");
        try{
...
clean:function(a,b,d,e){
    ...
    for(var j=0,k;(k=a[j])!=null;j++){
        ...
        if(typeof k=="string")if(!bb.test(k))k=b.createTextNode(k);
            ...
            k=k.replace(jQuery,"<jQuery1></jQuery2>");
...
var bo=/alpha\([^)]*\)/i,bp=/opacity=([^)]*)/,bq=/-([a-z])/ig,br=/([A-Z]|^ms)/g,bs=/^-?\d+(?:px)?jQuery/i,bt=/^-?\d/,bu=/^[+\-]=/,bv=/[^+\-\.\de]+/g,bw={
    position:"absolute",
    visibility:"hidden",
    display:"block"
...
camelCase:function(a){
    ...
    get:function(a,b){
        return bp.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.jQuery1)/100+"":b?"1":""
        },
    set:function(a,b){
    ...
    var d,e,g;
    c=c.replace(br,"-jQuery1").toLowerCase();
...
var bE=/%20/g,bF=/\[\]jQuery/,bG=/\r?\n/g,bH=/#.*jQuery/,bI=/^(.*?):[ \t]*([^\r\n]*)\r?jQuery/mg,bJ=/^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)jQuery/i,bK=/^(?:about|app|app\-storage|.+\-extension|file|widget):jQuery/,bL=/^(?:GET|HEAD)jQuery/,bM=/^\/\//,bN=/\?/,bO=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,bP=/^(?:select|textarea)/i,bQ=/\s+/,bR=/([?&])_=[^&]*/,bS=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,bT=f.fn.load,bU={},bV={},bW,bX;
try{
    bW=e.href
    }catch(bY){
...
if(!d.hasContent){
    ...
    if(d.cache===!1){
        var x=f.now(),y=d.url.replace(bR,"jQuery1_="+x);
...
f.ajaxSetup({
    ...
    if(b.dataTypes[0]==="jsonp"||b.jsonp!==!1&&(cd.test(b.url)||e&&cd.test(b.data))){
        var g,h=b.jsonpCallback=f.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,i=a[h],j=b.url,k=b.data,l="jQuery1"+h+"jQuery2";
...
var cj={},ck,cl,cm=/^(?:toggle|show|hide)jQuery/,cn=/^([+\-]=)?([\d+.\-]+)([a-z%]*)jQuery/i,co,cp=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],cq,cr=a.webkitRequestAnimationFrame||a.mozRequestAnimationFrame||a.oRequestAnimationFrame;
f.fn.extend({
    show:function(a,b,c){
        var d,e;
...
var cw=/^t(?:able|d|h)jQuery/i,cx=/^(?:body|html)jQuery/i;
